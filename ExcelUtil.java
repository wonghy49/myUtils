...
package com.richstonedt.transport.portal.cs.utils.excel;
 ...
 * Description
 * <p/>
 * <b>Creation Time:</b> 21-2-2 下午12:04.
 *
 * @author huanghuayan
...
public class ExcelUtil {
     ...
     * @return 数据
     */
    public static <T> List<T> readSync(InputStream inputStream, Class<T> clazz, AnalysisEventListener<T> analysisEventListener) {
        return EasyExcel.read(inputStream, analysisEventListener).head(clazz).sheet().doReadSync();
    }
